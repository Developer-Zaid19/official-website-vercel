...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center px-3.5 py-5 border-b-2 border-b-gray-800 bg-(--bg)">
      <h3 className="text-(--maincolor) font-bold text-3xl h3logo">&lt;DeveloperZaid/&gt;</h3>
            ...
            return (
              <Link
                ...
                className={`relative inline-block font-semibold ${isActive
                  ? "text-(--maincolor) after:block after:w-full after:h-0.5 after:bg-(--maincolor) after:absolute after:-bottom-1 after:left-0"
